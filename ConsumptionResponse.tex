...
\begin{center}
\begin{tabbing}
\texttt{~~~~~~Web:~} \= \= \url{http://econ-ark.github.io/Pandemic/} \\
\texttt{~~~GitHub:~} \> \> \url{http://github.com/econ-ark/Pandemic} \\
\texttt{Dashboard:~} \> \> \href{https://mybinder.org/v2/gh/econ-ark/Pandemic/master?urlpath=voila/render/Code/Python/dashboard.ipynb}{Interactive-Jupyter-Notebook}
\end{tabbing}
\end{center}
}
\end{small}
