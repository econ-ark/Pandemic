...
\renewcommand{\forcedate}{August 6, 2020}
...
A separate strand of work focuses on empirical studies of how the economy reacts to pandemics; see, e.g., \cite{baker_Cpandemic}, \cite{jorda_pandemics}, \cite{verner_pandemics} and \cite{chetty_covidC}.
