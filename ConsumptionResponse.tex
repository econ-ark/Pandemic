...
\provideboolean{ifNorm}\setboolean{ifNorm}{true} % If true, make Normal version, otherwise regular
...
\ifthenelse{\boolean{ifIJCB}}{\thanks{\thankstext}}{} % For either IJCB or Norm versions
\ifthenelse{\boolean{ifNorm}}{\thanks{\thankstext}}{} % Thanks text should begin on first page
...
\ifthenelse{\boolean{ifNBER}}{\thanks{\thankstext}            }{} % For NBER version, thanks at botom of 2nd page 
