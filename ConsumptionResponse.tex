...
\provideboolean{ifNorm}\setboolean{ifNorm}{true} % If true, make 'normal' version
\provideboolean{ifIJCB}\setboolean{ifIJCB}{false} % If true, make IJCB version, otherwise regular
\provideboolean{ifNBER}\setboolean{ifNBER}{false} % If true, make NBER version, otherwise regular
...
\ifthenelse{\boolean{ifNBER}}{\renewcommand{\versn}{NBER}}{} % Includes in tiny header 
...
\hfill{\tiny \jobname~\versn~\today, \tiny time: \DTMcurrenttime}
...
{% Not {Web}
  \author{
    Christopher D. Carroll\authNum \\ {\small JHU and NBER}
    \and
...
\ifthenelse{\boolean{ifIJCB}}{\thanks{\thankstext}}{} % Normal and IJCB versions
\ifthenelse{\boolean{ifNorm}}{\thanks{\thankstext}}{} % Thanks start onf first page
...
\ifthenelse{\boolean{ifNBER}}{\thanks{\thankstext}}{} % Put thanks text on 2nd page for NBER because first page gets replaced with their version
