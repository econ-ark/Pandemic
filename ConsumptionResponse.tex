...
\provideboolean{ifNorm}\setboolean{ifNorm}{false} % If true, make Normal version, otherwise regular
\provideboolean{ifIJCB}\setboolean{ifIJCB}{false} % If true, make IJCB version, otherwise regular
\provideboolean{ifNBER}\setboolean{ifNBER}{true} % If true, make NBER version, otherwise regular
