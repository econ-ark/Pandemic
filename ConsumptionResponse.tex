...
\renewcommand{\forcedate}{First Public Version: \href{https://github.com/econ-ark/Pandemic/blob/ccd3253fddac75e66cea8362aadd1fe1a13fe015/ConsumptionResponse.pdf}{April 15, 2020} \\
  Published Preprint: \href{https://cepr.org/sites/default/files/news/CovidEconomics10.pdf}{April 27, 2020} \\
This Version: September 5, 2020}
...
\newcommand{\thankstext}{The pre-print of this paper first appeared in CEPR's Covid Economics journal on April 27, 2020. Thanks to the \href{https://consumerfinance.gov}{Consumer Financial Protection Bureau} for funding the original creation of the \href{https://econ-ark.org}{Econ-ARK} toolkit, whose latest version we used to produce all the results in this paper; and to the Sloan Foundation for funding its extensive further development that brought it to the point where it could be used for this project.  The toolkit can be cited with its digital object identifier, \href{https://doi.org/10.5281/zenodo.1001067}{10.5281/zenodo.1001067}, as is done in the paper's own references as \cite{carroll_et_al-proc-scipy-2018}.
