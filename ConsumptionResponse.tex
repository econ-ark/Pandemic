...
\begin{abstract}
  ...
  Spending of unemployed households is strongly supported by the unemployment benefits, which arrive earlier and, per recipient, per recipient, are of much greater importance than the stimulus checks are to their recipients.
  ...
  To make it easy for others to see how our results would change with different assumptions, we are making available our complete economic modeling toolkit as an open-source software repository.  \href{https://github.com/econ-ark/Pandemic#reproduction-instructions}{See instructions here} to install and run our software on your own computer, or use our \href{http://www.google.com}{interactive dashboard} to explore alternate parametrizations in your browser.
\end{abstract}
