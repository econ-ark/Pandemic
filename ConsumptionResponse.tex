...
\input{./LaTeX/econtexRoot}\input{\econtexRoot/LaTeX/econtexPaths}\documentclass[titlepage,a4paper]{\econtex}

\provideboolean{ifIJCB}  
%\setboolean{ifIJCB}{false}\opt{ifIJCB}{\setboolean{ifIJCB}{false}} 
\setboolean{ifIJCB}{true}\opt{ifIJCB}{\setboolean{ifIJCB}{true}}  % Uncomment this line to generate IJCB version
...
\ifthenelse{\boolean{ifIJCB}}{\usepackage[nolists,nomarkers]{endfloat}}{\usepackage[nolists,nomarkers,tablesonly]{endfloat}} 
\usepackage{\econtexRoot/LaTeX/ConsumptionResponse}
% Needed to get nice fonts on ESC's machine
...
%\small First Public Version: \href{https://github.com/econ-ark/Pandemic/blob/ccd3253fddac75e66cea8362aadd1fe1a13fe015/ConsumptionResponse.pdf}{April 15, 2020} \\
% Published Preprint: \href{https://cepr.org/sites/default/files/news/CovidEconomics10.pdf}{April 27, 2020} \\ This Version: September 9, 2020} \\ \phantom{.}
...
%    \begin{table}
            \begin{tabular}[c]{lll}
        \href{https://econ-ark.org/pandemicdashboard}{Live Dashboard}                                                                          && \textit{See effect of modifying main assumptions}\\
        \href{https://econ-ark.github.io/Pandemic}{econ-ark.github.io/Pandemic}                                                           && \textit{HTML version of paper}                                                                 \\
        \href{https://github.com/econ-ark/Pandemic}{github.com/econ-ark/Pandemic}                                                         && \textit{Full codebase; modify combinations of assumptions}                                  \\
        \href{https://github.com/econ-ark/Pandemic/blob/master/LaTeX/ConsumptionResponse.pdf}{\phantom{~~}LaTeX subdirectory of $\uparrow$}         && \textit{PDF version of paper}                \\
        \href{https://github.com/econ-ark/Pandemic/blob/master/LaTeX/ConsumptionResponse-Slides.pdf}{\phantom{~~}LaTeX subdirectory of $\uparrow$}  && \textit{Presentation slides}          \\
        \href{https://github.com/econ-ark/Pandemic/blob/master/LaTeX/ConsumptionResponse-Self.bib}{\phantom{~~}BibTeX}                              && \textit{Preferred BibTeX citation}                          \\
            \end{tabular}
%    \end{table}
\end{small}
...
In the decade since the Great Recession, macroeconomics has made great progress by insisting that models be consistent with microeconomic evidence (see \cite{kmpHandbook} for a survey).  To predict the effects of the 2020 CARES Act (Coronavirus Aid, Relief, and Economic Security) on consumption, we take from this new generation \href{https://econ.jhu.edu/people/ccarroll/papers/cAndCwithSTickyE}{one model} that is specifically focused on reconciling apparent conflicts between micro and macro evidence about consumption dynamics, as documented in \cite{hrsHabit}, and adapt it to incorporate two aspects of the coronavirus crisis.
