...
plt.ylabel('Aggregate labor and transfer income (billion $)',fontname="Ariel",fontsize=9)
...
plt.tight_layout()
plt.savefig(figs_dir + 'AggLT_high_res.png', dpi=3000)
plt.show()
...
plt.tight_layout()
plt.savefig(figs_dir + 'AggConResp_examples_high_res.png', dpi=3000)
plt.show()
...
plt.tight_layout()
plt.savefig(figs_dir + 'ConRespByEmpStateNoStim_high_res.png', dpi=3000)
plt.show()
...
plt.ylim(bottom, top+500)
plt.tight_layout()
plt.savefig(figs_dir + 'ConRespByEmpStateWStim_high_res.png', dpi=3000)
plt.show()
...
##plt.ylim(bottom, top+500)
#plt.tight_layout()
#plt.savefig(figs_dir + 'ConRespByEmpStateDiff_high_res.png', dpi=3000)
#plt.show()
