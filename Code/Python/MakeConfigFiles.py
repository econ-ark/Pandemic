...
makeConfigFile('UnempD', -0.15, -2.15, 21)
makeConfigFile('UnempH', -0.30, -2.30, 21)
makeConfigFile('UnempC', -0.65, -2.65, 21)
makeConfigFile('UnempP', -0.2, 0.0, 21)
makeConfigFile('UnempA1', -0.03, 0.01, 21)
makeConfigFile('DeepD', -0.50, -2.50, 21)
makeConfigFile('DeepH', -0.75, -2.75, 21)
makeConfigFile('DeepC', -1.20, -3.20, 21)
