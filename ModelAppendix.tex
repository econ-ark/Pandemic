...
\begin{table}
  ...
  \begin{center}
    ...
    \end{tabular}
	\begin{flushleft}
	\footnotesize Note: The unemployment benefits are multiplied by 0.8 to account for the fact that 20 percent of the working age population is out of the labor force. See aggregation appendix \ref{sec:aggregation}
	\normalsize
\end{flushleft}
  \end{center}
\end{table}
